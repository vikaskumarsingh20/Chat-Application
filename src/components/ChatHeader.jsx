            ...
            <div className="mx-auto">
                <div className="h-screen">
                    <div className="flex border border-grey rounded shadow-lg h-full">
                        <div className="w-1/3 bg-blue-50 border flex flex-col">
                        ...
                        <div className="w-2/3 bg-[#f3f7f9] border flex flex-col">
                            ...
                            <div className="flex-1 bg-[#dad3cc] overflow-auto">
                                <div className="py-2 px-3">

                                    <div className="flex justify-center mb-2">
                                        <div className="bg-blue-50 rounded py-2 px-4">
